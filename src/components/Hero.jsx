...
import heroVideo from '../assets/hero video/Create_a_short_animated_video (1).mp4';
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="hidden lg:flex flex-col gap-6 fixed left-6 top-1/2 -translate-y-1/2 z-50 mix-blend-difference">
        ...
        <a 
          href={`mailto:${import.meta.env?.VITE_EMAIL || 'kyathi568@gmail.com'}`}
          className="text-white/60 hover:text-[#7C3AED] transition-all duration-300 transform hover:scale-125"
          aria-label="Email"
        >
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            ...
            <a href="mailto:kyathi568@gmail.com" className="text-white/60 hover:text-[#7C3AED]" aria-label="Email">
        ...
        <div 
          ...
          onClick={toggleVideo}
        >
          <div className="w-12 h-12 md:w-20 md:h-20 rounded-full border border-white/30 bg-black/20 backdrop-blur-md flex justify-center items-center group-hover:scale-110 group-hover:bg-[#7C3AED] transition-all duration-500 shadow-[0_0_30px_rgba(255,255,255,0.1)] group-hover:shadow-[0_0_40px_rgba(124,58,237,0.6)]">
            {!isPlaying || isMuted ? (
              // Play Icon
