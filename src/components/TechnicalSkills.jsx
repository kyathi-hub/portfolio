...
const SkillProgress = ({ name, level }) => (
  <div className="mb-4">
    <div className="flex justify-between items-center mb-1">
      ...
      <span className="text-violet-400 text-xs font-bold font-mono">{level}%</span>
    </div>
...
const SkillCard = ({ category, index }) => (
  <div 
    ...
    className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 hover:scale-[1.02] hover:border-violet-500/30 hover:shadow-[0_20px_50px_rgba(124,58,237,0.1)] transition-all duration-500"
  >
